...
```
./secure_keys.sh <previous private key> <current private key> <current public key> xxx.xxx.xxx.xxx

where 
- previous private key: could be bbb_initial_keys/bbb_initial.key, if first key change after installation
- current private key: key generated by ssh-keygen, typically id_rsa
- current publick key:  key generated by ssh-keygen, typically id_rsa.pub
- xxx.xxx.xxx.xxx:  IP address of BBB being changed
```
