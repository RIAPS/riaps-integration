...
pip3_3rd_party_installs(){
    pip3 install 'pydevd==2.3.0' 'redis==3.5.3' 'hiredis==1.1.0' 'netifaces==0.10.7' 'paramiko==2.7.2' 'cryptography==2.9.2' 'cgroups==0.1.0' 'cgroupspy==0.1.6' 'fabric3==1.14.post1' 'pyroute2==0.5.14' 'minimalmodbus==0.7' 'pyserial==3.4' 'pybind11==2.6.2' 'toml==0.10.2' 'pycryptodomex==3.10.1' 'spdlog==2.0.4' --verbose
    ...
    pip3 install 'textX==2.3.0' 'graphviz==0.5.2' 'pydot==1.4.2' 'gitpython==3.1.14' 'pymultigen==0.2.0' 'Jinja2==2.11.3' 'influxdb-client==1.15.0' --verbose
